...
// This is a hidden homepage that shows password protected stories and public stories. 
// There are 11 things for you to edit on this page. 
	...
	<div class="container-fluid bodyContainer">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-xl-3">
				<a class="btn btn-primary" id="searchButton" onclick="storySearch()"><i class="fas fa-search"></i>&nbsp; Search</a>
