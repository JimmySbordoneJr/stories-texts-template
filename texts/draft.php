...
// There are seven things for you to edit in this file. 
//	1. Change the text in quotes to set the username and password for viewing a password-protected story.

if($user == "exampleusername"
&& $pass == "password"){
    include("valid_draft.php");
}
else{
    if(isset($_POST))
    { ?>
...
<head>
		<?php $id = isset($_POST['story']) ? $_POST['story'] : $_GET['story'] 
		// if someone gets the username or password wrong, we need to make sure that the story ID number is not lost 
		?>
	<meta charset="UTF-8">
...
<body>
	<div class="hidden">
	<!-- 5. This is the bar at the top of the page. You can add or remove links to suit the sections of your websites. -->
	<nav class="navbar fixed-top navbar-dark bg-dark">
		<a class="navbar-brand" href="index.php">Stories & Texts</a>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8">
					<div class="black-box">
						<h1 class="text-center">Story Draft</h1>
						<p>We are currently working on adding this story to the website and checking our transcriptions. Please check back soon!</p>
						<!-- 6. If necessary, change the link in quotes after href to link to a contact form, or replace the <a ... </a> with an email address.  -->
						<p>If you would like the login credentials, please <a class="text-info" href="../contact">contact us!</a></p>
					</div>
				</div>
	...
	<footer class="container-fluid text-center footer">
		<div class="row">
			<div class="col">
				<!-- 7. Replace this with the name of your website -->
