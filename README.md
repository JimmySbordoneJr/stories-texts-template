...
This is the template code for creating interactive bilingual stories and texts. This user's guide will be expanded in the coming weeks to include more detailed instructions for downloading and using our code, but everything you need to get your own stories and texts database up and running is included. 
